...
object UtilityCNode {
  ...
  private def forAllSerial(body: Graph, schedueled: Seq[Literal], values: Seq[Literal]) = {
  ...
  private def forAllParallel(body: Graph, schedueled: Seq[Literal], values: Seq[Literal]) = {
